...
import { insertContainerStats, addNotification, getRecentAlerts, recordAlert, pruneOldStats, pruneOldAlerts, clearOldNotifications, getSetting, optimizeStatsDatabase } from './db';
let isRunning = false;
let intervalId = null;
