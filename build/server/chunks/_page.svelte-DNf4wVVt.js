import { a3 as onDestroy, c as escape_html, f as attr, b as stringify, e as ensure_array_like } from './index-server-Ip8I2Crl.js';
import { q as ArrowLeft, r as Trash, j as Play, k as Stop, A as ArrowClockwise, s as Terminal } from './lib--dU9BMBy.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></button></div> <div class="grid grid-cols-1 md:grid-cols-3 gap-6"><div class="md:col-span-2 card space-y-6"><div><p class="text-xs font-bold text-white/40 uppercase tracking-widest mb-4">resource usage</p> <div class="h-64 bg-black/20 rounded-xl overflow-hidden border border-white/5">`);
		StatsChart($$renderer, { containerId: data.container.id });
		$$renderer.push(`<!----></div></div></div> <div class="space-y-6"><div class="card space-y-4"><p class="text-xs font-bold text-white/40 uppercase tracking-widest">quick actions</p> <div class="grid grid-cols-2 gap-3">`);
		...
		$$renderer.push(`<!----> exec</a></div></div> <div class="card space-y-4"><p class="text-xs font-bold text-white/40 uppercase tracking-widest">cpu usage</p> `);
		StatsChart($$renderer, {
			id: data.container.id,
			label: "cpu"
		});
		$$renderer.push(`<!----></div> <div class="card space-y-4"><p class="text-xs font-bold text-white/40 uppercase tracking-widest">memory usage</p> `);
		StatsChart($$renderer, {
			id: data.container.id,
			label: "ram"
		});
		$$renderer.push(`<!----></div></div> <div class="grid grid-cols-1 lg:grid-cols-2 gap-6"><div class="card space-y-6"><div><p class="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">environment</p> <div class="space-y-2 max-h-64 overflow-y-auto pr-2 custom-scrollbar svelte-1a87x95"><!--[-->`);
		...
		$$renderer.push(`<!--]--></div></div> <div><p class="text-xs font-bold text-white/40 uppercase tracking-widest mb-3">ports</p> <div class="space-y-2"><!--[-->`);
		...
		$$renderer.push(`<!--]--></div></div></div> <div class="card flex flex-col h-[500px]"><p class="text-xs font-bold text-white/40 uppercase tracking-widest mb-4">live logs</p> <div class="flex-1 bg-black/50 rounded-lg p-4 font-mono text-[11px] overflow-y-auto custom-scrollbar svelte-1a87x95"><!--[-->`);
...
//# sourceMappingURL=_page.svelte-DNf4wVVt.js.map
