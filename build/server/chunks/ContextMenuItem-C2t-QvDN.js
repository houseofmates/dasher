...
function ContextMenuItem($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--> <span class="context-menu-item" style="text-transform: lowercase !important;">${escape_html(lowercaseLabel())}</span></button>`);
	});
}

export { ContextMenu as C, ContextMenuItem as a };
//# sourceMappingURL=ContextMenuItem-C2t-QvDN.js.map
